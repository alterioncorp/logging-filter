...
public class JdbcLoggerPluginDefaultImplTest {
	...
	public void testGetValueToInsert_0() {
		assertNull(plugin.getValueToInsert(0, new RequestInfo(), new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_1() {
		...
		assertEquals(startTimestamp, plugin.getValueToInsert(1, requestInfo, new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_2() {
		...
		assertEquals(ip, plugin.getValueToInsert(2, requestInfo, new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_3() {
		...
		assertEquals(ip, plugin.getValueToInsert(3, requestInfo, new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_4() {
		...
		assertEquals(method, plugin.getValueToInsert(4, requestInfo, new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_5() {
		...
		assertEquals(path, plugin.getValueToInsert(5, requestInfo, new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_6() {
		...
		assertEquals(params, plugin.getValueToInsert(6, requestInfo, new ResponseInfo(), request, response));
	}
	...
	public void testGetValueToInsert_7() {
		...
		assertEquals(Long.valueOf(duration), plugin.getValueToInsert(7, requestInfo, responseInfo, request, response));
	}
	...
	public void testGetValueToInsert_8() {
		...
		assertEquals(Integer.valueOf(responseCode), plugin.getValueToInsert(8, new RequestInfo(), responseInfo, request, response));
	}
	...
	public void testGetValueToInsert_9() {
		...
		assertEquals(sessionId, plugin.getValueToInsert(9, new RequestInfo(), responseInfo, request, response));
	}
	
	@Test
	public void testGetValueToInsert_10() {
		assertThrows(IllegalArgumentException.class, () -> plugin.getValueToInsert(10, new RequestInfo(), new ResponseInfo(), request, response));
	}
}
