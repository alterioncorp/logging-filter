...
public class JdbcLoggerPluginDefaultWithAdditionalColumnsTest {
	...
	public void testGetValueToInsert_Default() {
		...
		assertEquals(startTimestamp, plugin.getValueToInsert(1, requestInfo, responseInfo));
	}
	...
	public void testGetValueToInsert_Additional() {
		...
		assertEquals(ADDITIONAL_COLUMN_VALUE, plugin.getValueToInsert(startIndex, requestInfo, responseInfo));
	}
}
